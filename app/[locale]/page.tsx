    ...
    const handleAnalysis = async (files: File[]) => {
        ...
        try {
            ...
            if (!analysis.data?.identifiedAs) {
                throw new Error(t('errors.unidentified'));
            }
            ...
            <div className="max-w-3xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <div className="flex items-center justify-center gap-4 text-sm text-gray-500">
                        <div>{t('header.secure')}</div>
                        <div>{t('header.fileSize')}</div>
                    </div>
                </div>
                <div className="bg-white rounded-xl shadow-lg p-8 mb-12 hover:shadow-xl transition-all">
                    <div
                        {...getRootProps()}
                        className={[
                    ...
                    >
                        ...
                        <div className="space-y-4">
                           ...
                           0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 
                           2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"
                                            />
                                        </svg>
                                    </div>
                                    <p className="text-gray-600">
                                        {error || (isDragActive ? t('drop') : t('upload'))}
                                    </p>
                ...
                {result && (
                  ...
                  mb-8 rounded-lg overflow-hidden border border-gray-200"
                            >
                                <img
